...
public class addResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from student where Roll='"+RollNumber+"'");
            
            if(rs.next()){
               st.executeUpdate("insert into result(Roll,Maths,Physics,EM,OS,DBMS) values('"+RollNumber+"','"+Maths+"','"+Physics+"','"+EM+"','"+OS+"','"+DBMS+"')"); 
               JOptionPane.showMessageDialog(null, "Marks saved Successfully.");
               setVisible(false);
               new addResult().setVisible(true);
            }
            else{
                JOptionPane.showMessageDialog(null, "This roll nuumber is not registered! "); 
            }
        }
