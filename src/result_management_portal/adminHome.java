...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BTech", "BBA", "BCA", "BCom", "MCA", "MSC", "MTech", "MBA" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ECE", "CS", "IT", "EEE", "FT", "Civil", "Mechanical", "Accounting Principles", "Business Ethics", "Business Finance", "Human Resources Management", "Internet Technologies", "Animation", "Network Systems", "Programming Languages (C++, JAVA, etc.)", "Systems Analysis", "Music and Video Processing", "Management Information System (MIS)", "Accounting Application" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Other" }));

        jButton6.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_management_portal/icons8-student-16.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into student(Roll,Course,Branchname,Name,Gender,Fathername) values('"+RollNumber+"','"+course+"','"+BranchName+"','"+Name+"','"+Gender+"','"+FatherName+"')");
